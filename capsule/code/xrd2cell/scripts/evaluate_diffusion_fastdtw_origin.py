...
def main(args):
    ...
    if args.label == -1:
        save_name = 'last_sample%s_L%s_fastdtw_origin.pt'%(str(num_evals), str(num_L_sample))     ######last_one.ckpt
    else:
        save_name = 'best_sample%s_L%s_fastdtw_origin.pt'%(str(num_evals), str(num_L_sample))     ######best_one.ckpt
