...
def diffusion(loader, model, cell, step_lr = 1e-5):
    ...
    for idx, batch in enumerate(loader):
        ...
        outputs = model.sample_given_inital_cell(batch, cell, step_lr = step_lr)
...
def main(args):
    ...
    (frac_coords, atom_types, lattices, lengths, angles, num_atoms) = diffusion(test_loader, diff_model, cell)
