...
def flow(loader, model, given_lattices, num_evals, step_lr = 5, infer_timesteps=200):
...
def main(args):
    ...
    (frac_coords, atom_types, lattices, lengths, angles, num_atoms, input_data_batch) = flow(test_loader, diff_model, given_cell, num_eval)
    if args.label == -1:
